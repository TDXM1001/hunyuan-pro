...
const apiFiles = [
  {
    ...
    needles: [
      ...
      '/bpm/business-contract/visual-draft/create',
      '/bpm/business-contract/visual-draft/save',
      '/bpm/business-contract/visual-draft/validate',
      '/bpm/business-contract/technical-detail/',
      '/bpm/business-contract/references/',
  ...
  },
  {
    label: 'graph',
    needles: [
      '/bpm/graph-draft/query',
      '/bpm/graph-draft/create',
      '/bpm/graph-draft/save',
      '/bpm/graph-definition/publish',
      '/bpm/graph-definition/latest-by-draft/',
    ],
    path: 'apps/hunyuan-system/src/api/system/bpm/graph.ts',
  },
  {
    label: 'runtime',
    needles: [
