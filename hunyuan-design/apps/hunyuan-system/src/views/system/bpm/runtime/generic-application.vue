...
const workingData = ref<Record<string, any>>({});
...
const workingRules = computed(() => rulesFor(detail.value?.configuration?.workingDataSchema || []));
...
watch(selectedContract, async (contract) => {
  ...
  fields.value = {}; routingFacts.value = {}; workingData.value = {}; lineItems.value = []; attachments.value = [];
