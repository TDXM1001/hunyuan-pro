...
export const en = defineConfig({
  description: 'Hunyuan Design & Enterprise level management system framework',
  lang: 'en-US',
  themeConfig: {
    ...
    editLink: {
      pattern:
        'https://github.com/hunyuan/hunyuan-design/edit/main/docs/src/:path',
      text: 'Edit this page on GitHub',
    },
    footer: {
      copyright: `Copyright © 2020-${new Date().getFullYear()} Hunyuan`,
...
function nav(): DefaultTheme.NavItem[] {
  return [
    ...
    },
    {
      ...
      items: [
        {
          link: 'https://github.com/hunyuan/hunyuan-design/releases',
          text: 'Changelog',
        },
        {
        ...
        {
          link: 'https://github.com/hunyuan/hunyuan-design/blob/main/.github/contributing.md',
          text: 'Contribution',
        },
      ],
    },
