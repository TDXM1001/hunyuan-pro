...
<DemoPreview dir="demos/hunyuan-ellipsis-text/line" />

## 可折叠文本

通过 `line` 设置折叠后的最大行数，通过 `expand` 开启点击展开与收起。

<DemoPreview dir="demos/hunyuan-ellipsis-text/expand" />

## 自定义提示浮层

通过 `tooltip` 插槽自定义提示内容。

<DemoPreview dir="demos/hunyuan-ellipsis-text/tooltip" />

## 仅在省略时显示 Tooltip

通过 `tooltip-when-ellipsis` 控制仅在文本被截断时显示 Tooltip。

<DemoPreview dir="demos/hunyuan-ellipsis-text/auto-display" />
