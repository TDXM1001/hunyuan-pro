...
import { alert, prompt, useAlertContext, HunyuanButton } from '@hunyuan/common-ui';
...
<template>
  <div class="flex gap-4">
    <HunyuanButton @click="showPrompt">Prompt</HunyuanButton>
    <HunyuanButton @click="showSlotsPrompt"> Prompt With slots </HunyuanButton>
    <HunyuanButton @click="showSelectPrompt">Prompt With Select</HunyuanButton>
    <HunyuanButton @click="showAsyncPrompt">Prompt With Async</HunyuanButton>
  </div>
</template>
