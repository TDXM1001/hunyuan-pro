...
import { alert, confirm, HunyuanButton } from '@hunyuan/common-ui';
...
<template>
  <div class="flex gap-4">
    <HunyuanButton @click="showConfirm">Confirm</HunyuanButton>
    <HunyuanButton @click="showIconConfirm">Confirm With Icon</HunyuanButton>
    <HunyuanButton @click="showfooterConfirm">Confirm With Footer</HunyuanButton>
    <HunyuanButton @click="showAsyncConfirm">Async Confirm</HunyuanButton>
  </div>
</template>
