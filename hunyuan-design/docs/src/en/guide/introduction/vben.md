# About Hunyuan Design

::: info You are reading the documentation for [Hunyuan Design](https://github.com/hunyuan/hunyuan-design) version `5.0`!

- Hunyuan Design 2.x is currently archived and only receives critical fixes.
- The new version is not compatible with the old version. If you are using the old version (v2, v3), please refer to the [Hunyuan Design 2.x Documentation](https://doc.vvbin.cn).
...
- [Hunyuan Design](https://github.com/hunyuan/hunyuan-design) is still being actively updated. Contributions are welcome to help maintain and improve the project, aiming to create a better mid- to backend solution.
