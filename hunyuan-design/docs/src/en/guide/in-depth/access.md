...
With the permission codes, you can use the `AccessControl` component and API provided by `@hunyuan/access` to show and hide buttons.

#### Component Method

```vue
<script lang="ts" setup>
import { AccessControl, useAccess } from '@hunyuan/access';
...
```vue
<script lang="ts" setup>
import { AccessControl } from '@hunyuan/access';
</script>
