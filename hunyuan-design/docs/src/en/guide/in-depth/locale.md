...
import { updatePreferences } from '@hunyuan/preferences';
...
- Do not place business translation texts inside `@hunyuan/locales` to better manage business and general translation texts.
...
{
  "about": {
    "desc": "Hunyuan Design 是一个现代的管理模版。"
  }
}
````
...
{
  "about": {
    "desc": "Hunyuan Design is a modern management template."
  }
}
````
...
With `@hunyuan/locales`, you can easily use translation texts:
