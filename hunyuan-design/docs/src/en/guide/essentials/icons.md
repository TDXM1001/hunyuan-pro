...
- The icons in the project are mainly provided by the `@hunyuan/icons` package. It is recommended to manage them within this package for unified management and maintenance.
...
import { MdiKeyboardEsc } from '@hunyuan/icons';
</script>
...
```vue
<script setup lang="ts">
import { SvgTestIcon } from '@hunyuan/icons';
</script>
