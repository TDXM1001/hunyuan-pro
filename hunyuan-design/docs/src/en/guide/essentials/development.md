...
```json
{
  "scripts": {
    ...
    "build:antd": "pnpm run build --filter=@hunyuan/web-antd",
    // Build the web-antdv-next application separately
    "build:antdv-next": "pnpm run build --filter=@hunyuan/web-antdv-next",
    // Build the documentation separately
    "build:docs": "pnpm run build --filter=@hunyuan/docs",
    // Build the web-ele application separately
    "build:ele": "pnpm run build --filter=@hunyuan/web-ele",
    // Build the web-naive application separately
    "build:naive": "pnpm run build --filter=@hunyuan/web-naive",
    // Build the web-tdesign application separately
    "build:tdesign": "pnpm run build --filter=@hunyuan/web-tdesign",
    // Build the playground application separately
    "build:play": "pnpm run build --filter=@hunyuan/playground",
    ...
    "dev:antd": "pnpm -F @hunyuan/web-antd run dev",
    // Start the web-antdv-next application
    "dev:antdv-next": "pnpm -F @hunyuan/web-antdv-next run dev",
    // Start the documentation
    "dev:docs": "pnpm -F @hunyuan/docs run dev",
    // Start the web-ele application
    "dev:ele": "pnpm -F @hunyuan/web-ele run dev",
    // Start the web-naive application
    "dev:naive": "pnpm -F @hunyuan/web-naive run dev",
    // Start the web-tdesign application
    "dev:tdesign": "pnpm -F @hunyuan/web-tdesign run dev",
    // Start the playground application
    "dev:play": "pnpm -F @hunyuan/playground run dev",
    // Format code
...
Take the addition of the test environment `test` to `@hunyuan/web-antd` as an example:
...
"scripts": {
    ...
    "build:analyze": "turbo build:analyze",
    "build:antd": "pnpm run build --filter=@hunyuan/web-antd",
    "build-test:antd": "pnpm run build --filter=@hunyuan/web-antd build:test",
...
"tasks": {
    ...
    "build-test:antd": {
      "dependsOn": ["@hunyuan/web-antd#build:test"],
      "outputs": ["dist/**"]
    },

    "@hunyuan/web-antd#build:test": {
      "dependsOn": ["^build"],
      "outputs": ["dist/**"]
    },
