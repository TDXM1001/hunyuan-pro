...
The style files in the project are stored in `@hunyuan/styles`, which includes some global styles, such as reset styles, global variables, etc. It inherits the styles and capabilities of `@hunyuan-core/design` and can be overridden according to project needs.
...
import { useNamespace } from '@hunyuan/hooks';
