...
# Hunyuan Tiptap Rich Text Editor
...
<DemoPreview dir="demos/hunyuan-tiptap/basic" />
...
| -------- | ------------------------------ | ----------------------- |
| `change` | Triggered when content changes | `HunyuanTiptapChangeEvent` |

#### HunyuanTiptapChangeEvent

```ts
interface HunyuanTiptapChangeEvent {
...
<DemoPreview dir="demos/hunyuan-tiptap/image-upload" />
...
import { HunyuanTiptap } from '@hunyuan/plugins/tiptap';
...
<template>
  <HunyuanTiptap v-model="content" :extensions="extensions" />
</template>
```
