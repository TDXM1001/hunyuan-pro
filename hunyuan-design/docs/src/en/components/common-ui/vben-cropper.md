...
# Hunyuan Cropper Image Cropping
...
<DemoPreview dir="demos/hunyuan-cropper/basic" />

## Fixed Aspect Ratio

Set the cropping ratio via the `aspectRatio` prop. The format is `"width:height"`, e.g. `"1:1"`, `"16:9"`, `"3:4"`.

<DemoPreview dir="demos/hunyuan-cropper/aspect-ratio" />
...
import { ref } from 'vue';
import { VCropper } from '@hunyuan/common-ui';
