...
import type { OperateLogRecord } from '../client';
...
import { queryOperateLogDetail } from '../client';
import { usePlatformAuditRequestClient } from '../../dependencies';

const requestClient = usePlatformAuditRequestClient();
...
async function loadDetail() {
  ...
  loading.value = true;
  try {
    detailData.value = await queryOperateLogDetail(
      requestClient,
      props.operateLog.operateLogId,
    );
  } finally {
    loading.value = false;
  }
