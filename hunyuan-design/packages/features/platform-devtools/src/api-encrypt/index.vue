...
import type { ApiEncryptDemoPayload } from './client';
...
import { usePlatformDevtoolsRequestClient } from '../dependencies';
const requestClient = usePlatformDevtoolsRequestClient();
