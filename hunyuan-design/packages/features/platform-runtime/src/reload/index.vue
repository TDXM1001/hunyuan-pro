...
import type { ReloadFormModel, ReloadItemRecord } from './client';
...
import { queryReloadItems, updateReloadItem } from './client';
...
async function handleSubmit() {
  ...
  await updateReloadItem(requestClient, formData);
