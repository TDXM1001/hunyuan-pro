...
import type { TabDefinition } from '@hunyuan/types';

import type { IContextMenuItem } from '@hunyuan-core/tabs-ui';
...
import { getTabKey, useAccessStore, useTabbarStore } from '@hunyuan/stores';
import { filterTree } from '@hunyuan/utils';
