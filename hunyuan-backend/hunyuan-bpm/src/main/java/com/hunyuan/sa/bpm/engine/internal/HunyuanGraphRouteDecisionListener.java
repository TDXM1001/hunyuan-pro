...
/**
 * Evaluates one authored Graph gateway when Flowable enters its compiled gateway.
 */
@Component("hunyuanGraphRouteDecisionListener")
public class HunyuanGraphRouteDecisionListener implements ExecutionListener {
    ...
    public void notify(DelegateExecution execution) {
        ...
        bpmRouteDecisionService.writeGraphBranchVariables(execution, nodeKey, result.matchedBranchKeys());
    }
}
