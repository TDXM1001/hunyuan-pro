package com.hunyuan.sa.admin.module.platform.security.protection.service;
...
import com.hunyuan.sa.admin.module.platform.security.protection.dao.PasswordLogDao;
import com.hunyuan.sa.admin.module.platform.security.protection.domain.PasswordLogEntity;
...
@Service
public class SecurityPasswordService implements PlatformPasswordSecurityFacade {
    ...
    public ResponseDTO<String> validatePasswordComplexity(String password) {
        ...
        if (!PlatformPasswordCodec.hasRequiredCharacterCategories(password)) {
            return ResponseDTO.userErrorParam(PASSWORD_FORMAT_MSG);
        }
    ...
    public ResponseDTO<String> validatePasswordRepeatTimes(RequestUser requestUser, String newPassword) {
        ...
        boolean isDuplicate = oldPasswords.stream()
                .anyMatch(oldPassword -> PlatformPasswordCodec.matches(newPassword, oldPassword));
        if (isDuplicate) {
