package com.hunyuan.sa.admin.module.platform.file.service;
...
import com.hunyuan.sa.admin.module.platform.file.dao.FileDao;
import com.hunyuan.sa.admin.module.platform.file.domain.entity.FileEntity;
...
import com.hunyuan.sa.base.module.support.securityprotect.api.PlatformFileSecurityFacade;
...
public class FileService {
    ...
    @Resource
    private PlatformFileSecurityFacade fileSecurityFacade;
    ...
    public ResponseDTO<FileUploadVO> fileUpload(MultipartFile file, Integer folderType, RequestUser requestUser) {
        ...
        // 校验文件大小以及安全性
        ResponseDTO<String> validateFile = fileSecurityFacade.validateUpload(file);
