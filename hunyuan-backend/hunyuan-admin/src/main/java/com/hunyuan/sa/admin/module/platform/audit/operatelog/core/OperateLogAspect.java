package com.hunyuan.sa.admin.module.platform.audit.operatelog.core;
...
import com.hunyuan.sa.admin.module.platform.audit.operatelog.OperateLogDao;
import com.hunyuan.sa.admin.module.platform.audit.operatelog.domain.OperateLogEntity;
...
public abstract class OperateLogAspect {
    ...
    private static final String POINT_CUT = "@within(com.hunyuan.sa.base.module.support.operatelog.annotation.OperateLog) || @annotation(com.hunyuan.sa.base.module.support.operatelog.annotation.OperateLog)";
