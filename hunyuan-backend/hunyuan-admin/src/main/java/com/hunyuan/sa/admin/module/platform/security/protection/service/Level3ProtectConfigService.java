...
@Service
@Slf4j
public class Level3ProtectConfigService implements PlatformSecurityPolicyFacade {
    ...
    @Resource
    private PlatformConfigurationValueWriter configurationValueWriter;
    ...
    @PostConstruct
    void init() {
        String configValue = configurationValueReader.getValue(LEVEL3_PROTECT_CONFIGURATION_KEY);
    ...
    public ResponseDTO<String> updateLevel3Config(Level3ProtectConfigForm configForm) {
        ...
        return configurationValueWriter.updateValue(LEVEL3_PROTECT_CONFIGURATION_KEY, configFormJsonString);
    }
}
