package com.hunyuan.sa.admin.module.platform.runtime.job.constant;
...
public class SmartJobUtil {
    ...
    public static void main(String[] args) {
        ...
        ResponseDTO<String> res = checkJobClass("com.hunyuan.sa.admin.module.platform.runtime.job.sample.SmartJobSample1");
