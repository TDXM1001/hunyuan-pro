package com.hunyuan.sa.admin.module.platform.configuration.config.application;
...
import com.hunyuan.sa.base.module.support.config.api.PlatformConfigurationValueWriter;
...
public class PlatformConfigurationApplicationService implements PlatformConfigurationFacade,
        PlatformConfigurationValueReader, PlatformConfigurationValueWriter {
    ...
    public String getValue(String configurationKey) {
        return configService.getConfigValue(configurationKey);
    }

    @Override
    public ResponseDTO<String> updateValue(String configurationKey, String configurationValue) {
        return configService.updateValueByKey(configurationKey, configurationValue);
    }
}
