package com.hunyuan.sa.admin.module.platform.file.application;
...
public class PlatformFileApplicationService implements PlatformFileFacade {
    ...
    @Override
    public List<PlatformFileSummary> getFiles(List<String> fileKeys) {
        return SmartBeanUtil.copyList(fileService.getFileList(fileKeys), PlatformFileSummary.class);
    }
