package com.hunyuan.sa.admin.module.platform.audit.loginlog;
...
public class LoginLogService {
     ...
     */
    public LoginLogVO queryLastByUserId(Long userId, Integer userType, LoginLogResultEnum loginLogResultEnum) {
