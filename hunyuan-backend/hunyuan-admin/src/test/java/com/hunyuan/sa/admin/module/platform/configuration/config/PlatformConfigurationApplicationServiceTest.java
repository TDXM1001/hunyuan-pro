package com.hunyuan.sa.admin.module.platform.configuration.config;

import com.hunyuan.sa.base.common.domain.PageResult;
import com.hunyuan.sa.base.common.domain.ResponseDTO;
import com.hunyuan.sa.admin.module.platform.configuration.config.ConfigService;
import com.hunyuan.sa.admin.module.platform.configuration.config.application.PlatformConfigurationApplicationService;
import com.hunyuan.sa.admin.module.platform.configuration.config.domain.ConfigQueryForm;
import com.hunyuan.sa.admin.module.platform.configuration.config.domain.ConfigAddForm;
import com.hunyuan.sa.admin.module.platform.configuration.config.domain.ConfigUpdateForm;
import com.hunyuan.sa.admin.module.platform.configuration.config.domain.ConfigVO;
...
class PlatformConfigurationApplicationServiceTest {
    ...
    @Test
    void publishesValueReadAndUpdateWithoutExposingConfigurationInternals() {
        when(configService.getConfigValue("module.sample.enabled")).thenReturn("true");
        when(configService.updateValueByKey("module.sample.enabled", "false"))
                .thenReturn(ResponseDTO.ok());

        assertThat(service.getValue("module.sample.enabled")).isEqualTo("true");
        assertThat(service.updateValue("module.sample.enabled", "false").getOk()).isTrue();

        verify(configService).getConfigValue("module.sample.enabled");
        verify(configService).updateValueByKey("module.sample.enabled", "false");
    }
}
